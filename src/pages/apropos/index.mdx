...
#### Conception de matériel audio-visuel sur IOS

Je suis un utilisateur des produits Apple, tout particulièrement les appareils iPhone et iPad que j’utilise dans la création et montage de vidéos, la photographie, la composition de trame musicale, composition de billet de blogue et j’en passe.

Ayant fait l’acquisition de plus de 1,100 applications sous IOS, j’ai monté une combinaison de logiciels ultra-performants, beaucoup plus abordable que leurs équivalences roulant sous Windows et Mac OSX.

#### Gatsby JS -- GraphQL -- MDX

- Adapter Gatsby[^2] JS, un générateur de sites Web statique, pour diverses _saveurs_ de site WEB
...
- Promotion, solutions de gestion de projets agile en milieu manufacturier en utilisant Wekan[^3] Vivify ou Trello
...
Voici mon C.V.:   <a href="https://drive.google.com/file/d/1yQkDRLupiOFY-ZYBdmoz6c09c-4D2mPF/view?usp=sharing" target="_blank">François Meehan C.V.</a>
...
Je suis fier d'avoir eu plus de 1,2 million de visites sur mon site Flickr[^4], vu mes oeuvres exposer au Musée d’art contemporain de Montréal, monté des tablettes digitales pour des expositions muséales qui sont maintenant dotées de fonctions, par exemple *le mode portrait* qui n'a pas d'équivalence chez les caméras digitales conventionnelles.
...
[^1]: Article dans la revue [SysAdmin](https://www.drdobbs.com/snmp-trap-handling-with-nagios/199102017)
[^2]: [Gatsby](https://www.gatsbyjs.org/) générateur de site WEB statique 
[^3]: [Wekan](https://www.gatsbyjs.org/) Wekan gestion de projet Kanban
[^4]: [Stats](https://www.flickr.com/photos/12149783@N04/stats) de visites sur Flickr
